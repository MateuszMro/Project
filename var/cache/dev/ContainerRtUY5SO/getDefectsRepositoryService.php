 ...
 */
class getDefectsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DefectsRepository' shared autowired service.
     *
     * @return \App\Repository\DefectsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DefectsRepository.php';

        return $container->privates['App\\Repository\\DefectsRepository'] = new \App\Repository\DefectsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
