...
class __TwigTemplate_295edb8fc037b7bb64ef41cd66c0593b extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "                        </dd>
                    ...
                    <div class=\"py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6\">
                        ...
                        <dd class=\"mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2\">
                            ";
        // line 79
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 79, $this->source); })()), "user", [], "any", false, false, false, 79), "createdDate", [], "any", false, false, false, 79), "html", null, true);
        echo "
                        </dd>
                    </div>
                    <div class=\"py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6\">
                        ...
                        <dd class=\"mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2\">
                            ";
        // line 87
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 87, $this->source); })()), "user", [], "any", false, false, false, 87), "IP", [], "any", false, false, false, 87), "html", null, true);
        echo "
                        </dd>
                    </div>
                </dl>
...
";
    ...
    {
        return array (  224 => 101,  213 => 94,  211 => 93,  202 => 87,  191 => 79,  182 => 72,  179 => 71,  175 => 69,  172 => 68,  168 => 66,  165 => 65,  161 => 63,  158 => 62,  154 => 60,  151 => 59,  149 => 58,  138 => 50,  118 => 33,  107 => 25,  88 => 8,  78 => 7,  59 => 3,  36 => 1,);
    }
