...
class __TwigTemplate_3ba55ba4fd7763dd75a771b4438ece57 extends Template
{
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        <div class=\"container h-full px-6 py-24\">
            <div class=\"g-6 flex h-full flex-wrap items-center justify-center lg:justify-between\">
                ...
                <div class=\"md:w-8/12 lg:ml-6 lg:w-5/12 bg-gray-800 px-14 py-14 rounded-lg\">
                    <h1 class=\"text-xl font-bold leading-tight tracking-tight text-white md:text-2xl py-12 flex justify-center\">
                        Logowanie
                    </h1>
                    <form method=\"post\">
                        <!-- Email input -->
        ...
        echo "\"
                        ...
                        <!-- Password input -->
                        <div class=\"relative mb-6\" data-te-input-wrapper-init>
                            <label for=\"password\" class=\"block text-base font-medium text-white\">Hasło</label>
                            <input
                                    type=\"password\"
                                    name=\"password\"
                                    id=\"password\"
        ...
        echo "\"
                        ...
                        <div class=\"mt-5 text-blue-300 flex justify-between\">
                            <div>
                                <a href=\"/reset-password\" class=\"ease-in-out hover:scale-110\">Nie pamiętasz hasła?</a>
                            </div>
                            <div>
