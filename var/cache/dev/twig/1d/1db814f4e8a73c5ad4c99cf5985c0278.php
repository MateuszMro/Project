...
class __TwigTemplate_0979e86007e8bf7efc3c9b670a576772 extends Template
{
    private $source;
    private $macros = [];
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_SUPER_ADMIN")) {
            ...
            echo "                        <div class=\"py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6\">
                            ...
                            <dd class=\"mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2\">
                                <a href=\"/super-admin-panel\" class=\"font-bold underline text-red-500\">Wejdź do panelu Super Admina</a>
                            </dd>
                        </div>
                    ";
        }
